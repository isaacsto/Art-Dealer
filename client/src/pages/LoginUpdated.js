            ...
            <form className="form form-signup" onSubmit={handleSignUpSubmit}>
              <fieldset>
                ...
                <div className="input-block">
                  ...
                  <input id="signup-firstname" type="text" name="firstName" placeholder="Your First Name" onChange={handleSignUpChange} required />
                </div>
                <div className="input-block">
                ...
                <div className="input-block">
                  ...
                  <input id="signup-username" type="text" placeholder="username" onChange={handleSignUpChange} required />
                </div>
                <div className="input-block">
                  <label htmlFor="signup-email">E-mail</label>
                  <input id="signup-email" type="email" placeholder="Your Email" onChange={handleSignUpChange} required />
                </div>
                <div className="input-block">
                  <label htmlFor="signup-password">Password</label>
                  <input id="signup-password" type="password" placeholder="Your Password" onChange={handleSignUpChange} required />
                </div>
              </fieldset>
